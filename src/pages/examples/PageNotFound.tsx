  ...
  return (
    <ExampleShell exampleTitle="Page not found" phaseBanner={false}>
      <div className="max-w-2xl space-y-6">
        ...
        <p className="text-lg leading-7">If you typed the web address, check it is correct.</p>
        <p className="text-lg leading-7">If you pasted the web address, check you copied the entire address.</p>
